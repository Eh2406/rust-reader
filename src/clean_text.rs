...
mod tests {
    ...
    fn two_word_with_tabs_u8idx() {
        ...
        assert_eq!(invert_u8idx(&vec_u8idx, 5..6), 5..12);
        assert_eq!(invert_u8idx(&vec_u8idx, 6..7), 6..13);
    ...
    fn two_word_with_underscore_u8idx() {
        ...
        assert_eq!(invert_u8idx(&vec_u8idx, 0..5), 0..5);
        assert_eq!(invert_u8idx(&vec_u8idx, 3..5), 3..5);
        assert_eq!(invert_u8idx(&vec_u8idx, 7..9), 7..15);
        assert_eq!(invert_u8idx(&vec_u8idx, 9..10), 9..16);
    ...
    fn two_word_with_longchar_u8idx() {
        ...
        assert_eq!(invert_u8idx(&vec_u8idx, 0..5), 0..5);
        assert_eq!(invert_u8idx(&vec_u8idx, 3..5), 3..5);
        assert_eq!(invert_u8idx(&vec_u8idx, 5..6), 5..6);
        assert_eq!(invert_u8idx(&vec_u8idx, 6..18), 6..26);
        assert_eq!(invert_u8idx(&vec_u8idx, 18..20), 18..28);
    ...
    fn two_word_with_multichar_u8idx() {
        ...
        assert_eq!(invert_u8idx(&vec_u8idx, 18..19), 18..27);
        assert_eq!(invert_u8idx(&vec_u8idx, 14..18), 14..26);
